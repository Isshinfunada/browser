...
build :
	...
	cd saba && $(CARGO) build $(APP_BUILD_ARG)
...
clippy :
	...
	cd saba && cargo clippy --all-features --target=$(TARGET) -- -D warnings
	cd saba && cargo clippy --all-features -- -D warnings

.PHONY : objdump
objdump :
	cargo install cargo-binutils
	rustup component add llvm-tools-preview
	cd saba && $(CARGO) objdump -- -d
